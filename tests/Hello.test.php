...
require_once dirname(__DIR__) . '/src/Hello.class.php';
require_once dirname(__DIR__) . '/src/Nop.class.php';
require_once dirname(__DIR__) . '/src/dumy.lib.php';
...
test('Wazza - grettings',function(TAPHP $t){
   require_once dirname(__DIR__) . '/src/Wazza.class.php';
